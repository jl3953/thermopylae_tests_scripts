...
plot ARG1 using "ops/sec(inst)":"p50(ms)" with linespoint,\
		 "" using "ops/sec(inst)":"p50(ms)":"concurrency" with labels point pt 7
...
#set output ARG3
#set offset 1, 1, 1, 1
#plot ARG1 using "ops/sec(inst)":"p95(ms)" with linespoint,\
#		 "" using "ops/sec(inst)":"p95(ms)":"concurrency" with labels point pt 7
 offset char 1, 1 notitle
...
set output ARG4
set offset 1, 1, 1, 1
plot ARG1 using "ops/sec(inst)":"p99(ms)" with linespoint,\
		 "" using "ops/sec(inst)":"p99(ms)":"concurrency" with labels point pt 7 offset char 1, 1 notitle
