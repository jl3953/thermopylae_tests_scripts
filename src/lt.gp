...
#		 "" using "ops/sec(cum)":"p95(ms)":"concurrency" with labels point pt 7 offset char 1, 1 notitle
...
plot ARG1 using "ops/sec(cum)":"p99(ms)" with linespoint,\
		 "" using "ops/sec(cum)":"p99(ms)":"concurrency" with labels point pt 7 offset char 1, 1 notitle
